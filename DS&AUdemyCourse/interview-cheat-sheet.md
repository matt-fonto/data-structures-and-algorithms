...
1. Clarification → Ask enough questions to understand the context
2. Think out loud → Express and communicate your thought solution process
3. Talk before you write → Explain how you’d solve that, then code it
...
✅ Modular: makes code more readable, maintanable, and testable
✅ Less than O(n^2): Avoid nested loops. Two separate loops are better than 2 nested ones
